...
function SectionProblem() {
  return (
    <section className="lp-section lp-section--alt lp-section-host" data-section="problem" data-screen-label="§2 Problem">
      <div className="lp-annot">§2 · Problem · Agitate · no fluff, no buttons</div>
      <div className="lp-shell">
        <div className="mx-auto max-w-3xl text-center">
          <span className="lp-eyebrow">Why The KPI Hub Exists</span>
          <h2 className="lp-h2 mt-4">
            Every business is drowning in data.<br/>
            Almost none of it is <em>actionable.</em>
          </h2>
          <div className="mt-10 space-y-3 text-lg leading-relaxed text-ink-2">
          ...
          <span className="mt-8 inline-block font-display text-2xl italic text-gold">That ends here.</span>
        </div>
      </div>
    </section>
  );
...
function SectionPlatform() {
  return (
    <section className="lp-section lp-section-host" data-section="platform" data-screen-label="§3 Platform">
      <div className="lp-annot">§3 · Platform intro · Category definition</div>
      <div className="lp-shell">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="lp-platform-text">
            <span className="lp-eyebrow">What Is TheKPIHub</span>
            <h2 className="lp-h2 mt-4">
            ...
            <span className="mt-6 inline-block font-head text-sm uppercase tracking-wide text-gold/90">✦ Register once · Log in · Your world is already waiting</span>
          </div>
...
function SectionPersonas() {
  ...
  return (
    <section className="lp-section lp-section--alt lp-section-host" data-section="personas" data-screen-label="§4 Personas">
      ...
      <div className="lp-shell">
        <div className="grid gap-6 lg:grid-cols-[1fr_minmax(0,28rem)] lg:items-end">
          <div>
            <span className="lp-eyebrow">Built for every layer</span>
            <h2 className="lp-h2 mt-4">Your role. Your <em>dashboard.</em><br/>Your intelligence.</h2>
          </div>
          <p className="lp-lead">
        ...
        <div className="lp-persona-body mt-12 grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          <div className="lp-persona-copy">
            <span className="font-head text-xs font-semibold uppercase tracking-[0.16em] text-ink-3">{P.forLabel}</span>
            <h3 className="mt-3 font-display text-2xl font-bold leading-tight text-ink sm:text-3xl [&_em]:italic [&_em]:text-gold">{P.headline}</h3>
            <p className="mt-4 text-lg leading-relaxed text-ink-2">{P.body}</p>
            <a className="mt-6 inline-flex items-center gap-1.5 font-head font-semibold text-gold transition-colors hover:text-gold/80" href={P.href}>{P.link} →</a>
          </div>
          <P.Dash />
        </div>
      </div>
